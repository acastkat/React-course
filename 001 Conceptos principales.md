...
Renderizás distinto según esos datos.Idea central: React te ayuda a construir interfaces a partir de componentes (piezas reutilizables) que devuelven “cómo debería verse” la UI según el estado actual.
